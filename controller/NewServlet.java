...
public class NewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String createState = "", updateState = ""; 
            ...
            if(button != null) {
                if(button.equals("create")) {
                    ...
                    if(name != null && status != null && chapterAmount != 0 && thumbnail != null) {
                        db.UpdateStory(currentName, story);
                        updateState = "Successfull!";
                    }
                    else
                        updateState = "Story not valid!";
                }
            }
            ...
            request.setAttribute("chapterAmount", chapterAmount);
